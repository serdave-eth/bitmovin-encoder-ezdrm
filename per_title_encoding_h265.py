...
from bitmovin_api_sdk import AacAudioConfiguration, AclEntry, AclPermission, AutoRepresentation, \
    ...
    H264VideoConfiguration, H265PerTitleConfiguration, H265VideoConfiguration, HlsManifest, HlsManifestDefault, HlsManifestDefaultVersion, HttpInput, \
...
EXAMPLE_NAME = "PerTitleEncoding_noHLS_h265"
...
def main():
    ...
    # 480p configurations for H.265
    #_create_h265_video_configuration(width=854, height=480, bitrate=500000),  # Lower end for simpler content
    #_create_h265_video_configuration(width=854, height=480, bitrate=1500000),  # Higher end for more complex content
    
    # 720p configurations
    #_create_h265_video_configuration(width=1280, height=720, bitrate=1500000),  # Lower end for simpler content
    #_create_h265_video_configuration(width=1280, height=720, bitrate=3000000),  # Higher end for more complex content
    
    # 1080p configurations
    #_create_h265_video_configuration(width=1920, height=1080, bitrate=3000000),  # Lower end for simpler content
    #_create_h265_video_configuration(width=1920, height=1080, bitrate=6000000),  # Higher end for more complex content
    
    # 1440p configurations
    #_create_h265_video_configuration(width=2560, height=1440, bitrate=6000000),  # Lower end for simpler content
    #_create_h265_video_configuration(width=2560, height=1440, bitrate=13000000),  # Higher end for more complex content
    
    # 4K configurations
    #_create_h265_video_configuration(width=3840, height=2160, bitrate=15000000),  # Lower end for simpler content
    #_create_h265_video_configuration(width=3840, height=2160, bitrate=30000000)  # Higher end for more complex content
    #]
    ...
    #        codec_configuration=config,
    #        stream_mode=StreamMode.PER_TITLE_TEMPLATE
    #    )
    #    h265_video_muxing = _create_fmp4_muxing(
    #        encoding=encoding,
    #        output=output,
    ...
    # Create a fragmented MP4 muxing with the H.265 stream
    _create_fmp4_muxing(
        encoding=encoding,
        output=output,
        output_path="video/{height}/{bitrate}_{uuid}",
...
def _create_h265_video_configuration():
    ...
    config = H265VideoConfiguration(
        name="Base H.265 video config",
        preset_configuration=PresetConfiguration.VOD_STANDARD,
    )
    #config = H265VideoConfiguration(name=f"H.265 {height}p", width=width, height=height, bitrate=bitrate, preset_configuration=PresetConfiguration.VOD_STANDARD)
